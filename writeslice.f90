subroutine writeslice(frame_int,step,consump,Tr,s,T,rho,u,v,w,vor,     &
     freqN2,shear,fricb,stressx,yc,zc,dtfsec)                            
  !     ------------------------------------------------------------      
  USE dimensions
...
!      INCLUDE '/sw/lib/netcdf-gfortran/include/netcdf.inc'             
     ...
     &     Tr(ntr,0:NI+1,0:NJ+1,0:NK+1),shear(0:NI+1,0:NJ+1,0:NK+1),    &
     &     vor(0:NI+1,0:NJ+1,0:NK+1),freqN2(0:NI+1,0:NJ+1,0:NK+1),      &
     &     zc(0:NI+1,0:NJ+1,0:NK+1),fricb(NI,NJ,NK),stressx(NJ),        &
     &     yc(0:NJ+1),bs1(NK)                                           
      real*4 yslice(NJ),zslice(NJ,NK),conslice(ntr,NJ,NK),              &
...
!     Zonally averaged psi and by,bz                                    
      ...
      double precision   psiw(NJ,NK),psiv(NJ,NK),bybar(NJ,NK),          &
     ...
     &     wpvbar(NJ,NK),pvbar(NJ,NK),by(NJ,NK)                      
      double precision Feddydiv(NJ,NK),Freyndiv(NJ,NK),                 &
     &     cybar(ntr,NJ,NK),czbar(ntr,NJ,NK),                           &
     &     vcbar(ntr,NJ,NK),wcbar(ntr,NJ,NK),csfeddy(ntr,NJ,NK)         
                                                                        
      real*4 byslice(NJ,NK),bysection(NJ,NK),bzslice(NJ,NK),            &
     &      psivslice(NJ,NK),            &
     ...
     &     wpvbarsl(NJ,NK),pvbarsl(NJ,NK),trbarsl(ntr,NJ,NK)            
      ...
      real*4 Feddydivsl(NJ,NK),Freyndivsl(NJ,NK),cybarsl(ntr,NJ,NK),    &
