...
!     Assumes that rho is evaluated just prior to this call             
      ...
      integer n1 
      parameter (n1=3) 
      double precision fac,bvfreq,grho,RiCr,Ri,vshear,DLinv 
