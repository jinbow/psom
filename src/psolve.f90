subroutine psolve(p,dtime,nstep,edt) 
  ...
  double precision cp(19,NI,NJ,NK),rhs(NI,NJ,NK),                   &
...
!                                                                       
         if (maxres.gt.3000.d0) then 
            write(6,*) 'STOP. res too large, i,j,k,maxres(in psolve)=', &
     &           maxres,imax,jmax,kmax                                  
            stop 
         end if 
         write(6,*) iter,maxres,imax,jmax,kmax 
!     do l=1,3                                                          
!     call  mgpfill(dtime,p)                                            
!     end do                                                            
