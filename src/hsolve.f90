...
!         write(6,*) 'iter,maxres',iter,maxres                          
         if (maxres.gt.3000.d0) then 
            write(6,*) 'STOP. res too large, i,j,maxres=',              &
     &           i,j,maxres                                             
            stop 
         end if 
...
!      do j=16,18                                                       
         ...
         write(70,*) 'j =',j 
         do i=1,NI 
            write(60,*) 'rhs',rhs(i,17),(ch(l,i,17),l=1,2) 
            write(70,*) 'ch',(ch(l,i,17),l=3,5) 
         end do 
         do i=1,NI 
            write(80,*) h(i,16),h(i,17),h(i,18) 
         end do 
!      end do                                                           
      stop 
