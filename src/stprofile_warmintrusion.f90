...
!     tightness=4, gives the needed b_xx to make b_xx H/ (2f^2) < 1.    
     ...
     &     z,seval,zmm,sbkgrnd,z1,z2,zprev                              
...
!     &     1025.3558, 1025.3215 /                                       
      ...
      data tvert / 17.04, 17.25, 16.76, 16.01, 14.46, 13.28, 12.63,     &
          12.12, 11.71, 11.00, 10.42,  9.82,  8.75,  7.83,  6.96,  6.37,&
          5.71,  5.29,  4.84,  4.57,  4.32,  4.06,  3.80,  3.62,  3.28, &
          3.05,  2.61,  2.18,  1.87,  1.78,  1.77,  1.72,  1.61
