subroutine N2budget(step) 
  ...
  !     zeta*b is vor*b. So zeta*b/(f H) is in (per s^2)                  
      ...
      double precision depth,dz,dzt,dzb,dyinv,dxinv,dzinv,zbt,          &
     &     flocalinv,flocal,bx,by,bz,grav,adv,vol                       
      double precision avezf(NK),avezc(NK),avexyN2(NK),testdepth(3) 
      double precision b(NI,NJ,NK),Dbdt(NI,NJ,NK) 
