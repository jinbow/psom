subroutine advecn(m,n,dtime,step) 
  ...
  double precision dTrx(ntr,0:NI+1),dsx(0:NI+1),dux(0:NI+1),        &
  ...
  double precision s_restore(0:NJ+1),alph_restore(0:NJ+1) 
...
!            wflx(i,j,k)= w(i,j,k,m)*wf(i,j,k)                          
      ...
      call diffusion(sdif,Tdif,Trdif,udif,vdif,m,step) 
