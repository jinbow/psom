...
!      INCLUDE '/sw/lib/netcdf-gfortran/include/netcdf.inc'             
     ...
     &     yc(0:NJ+1),bs1(NK)                                           
      real*4 yslice(NJ),zslice(NJ,NK),sslice(ntr,NJ,NK),                &
...
!     Zonally averaged psi and by,bz                                    
     ...
     &     wpvbar(NJ,NK),pvbar(NJ,NK)                                   
      double precision cybar(ntr,NJ,NK),czbar(ntr,NJ,NK),               &
     &     vcbar(ntr,NJ,NK),wcbar(ntr,NJ,NK)
                                                                        
      real*4 byslice(NJ,NK),bzslice(NJ,NK),psivslice(NJ,NK),            &
     ...
     &     wpvbarsl(NJ,NK),pvbarsl(NJ,NK),trbarsl(ntr,NJ,NK)            
      ...
      real*4 divmeansl(NJ,NK),divreynsl(NJ,NK),prodsl(NJ,NK),           &
