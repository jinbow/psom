...
!     &     v4(0:NI+1,0:NJ+1,0:NK+1),v5(0:NI+1,0:NJ+1,0:NK+1)           
      ...
      double precision res,resmax,fiter,fzero 
...
!            do i=0,NI+1                                                
!               v1(i,j,k)= u(i,j,k,n)                                   
!c               v2(i,j,k)= v(i,j,k,n)                                  
!               v3(i,j,k)= p(i,j,k)                                     
!c               v4(i,j,k)= (p(i,j+1,k)-p(i,j,k))                       
!c               v5(i,j,k)= skfc(i,j,k)                                 
!            end do                                                     
!         end do                                                        
!      end do                                                           
!      do k=1,NK                                                        
...
!c         do j=1,NJ                                                    
!c            do i=0,NI                                                 
!c               v5(i,j,k)= vifc(i,j,k)                                 
!c            end do                                                    
!c         end do                                                       
!      end do                                                           
!      call outarray(v1,v2,v3,v4,v5)                                    
!      write(6,*) 'stopping in geostroph'                               
!      stop                                                             
